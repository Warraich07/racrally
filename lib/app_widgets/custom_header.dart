...
class CustomHeader extends StatelessWidget {
  const CustomHeader({super.key,this.title,this.subTitle,this.showSubtitle,this.showPopUpMenu});
  final String? title;
    ...
    return  SizedBox(
      ...
      child: Column(
          children: [
            ...
            showSubtitle==false? Container():Text(subTitle??"Manchester,London,UK",style: AppTheme.bodyExtraSmallWeight400Style,),
          ],
        ),
    );
